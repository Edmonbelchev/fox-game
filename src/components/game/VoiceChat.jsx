            ...
            {!isConnected ? (
              <button
                ...
                className="w-full sm:w-auto px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 
                        transition-colors flex items-center justify-center space-x-2 disabled:opacity-50"
              >
              ...
              >
                ...
                {speakingUsers.has(participant.id) && (
                  <div className="flex space-x-1">
                    <div className="w-1 h-3 bg-green-500 rounded-full animate-[soundWave_0.5s_ease-in-out_infinite]" />
                    <div className="w-1 h-3 bg-green-500 rounded-full animate-[soundWave_0.5s_ease-in-out_infinite_0.1s]" />
                    <div className="w-1 h-3 bg-green-500 rounded-full animate-[soundWave_0.5s_ease-in-out_infinite_0.2s]" />
                  </div>
                )}
              </div>
            ))}
